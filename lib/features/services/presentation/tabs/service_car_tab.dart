...
class CarServicesTab extends StatefulWidget {
  const CarServicesTab({
    super.key,
  });

  @override
  State<CarServicesTab> createState() => _CarServicesTabState();
}

class _CarServicesTabState extends State<CarServicesTab> with SingleTickerProviderStateMixin {
    ...
    return Padding(
      ...
      child: Column(
        children: [
          Gap(16),
          ListTileTarget(
            title: LocaleKeys.title_car.tr(),
            label: "Chevrolet Gentra, Oq, 2021, 01 L 784 FR",
            onTab: () {
                ...
                ListView(
                  ...
                  children: [
                    ...
                    ServiceItemWidget(
                      title: "Remont",
                      label: "Narxi kelishilgan holatda",
                      image: AppImages.remont_car,
                      onInfoTap: () {
                        context.pushNamed(AppRouter.servicesAboutServices, extra: "Remont");
                      },
                      onAddTap: () {},
                    ),
                  ],
