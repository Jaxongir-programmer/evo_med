...
class GetHomeServicesUseCase implements UseCase<HomeStatisticEntity, NoParams> {
  final HomeRepository homeRepository;

  GetHomeServicesUseCase({
    required this.homeRepository,
  });

  @override
  Future<Either<Failure, HomeStatisticEntity>> call(NoParams params) async {
    return await homeRepository.getHomeStatistics();
  }
}
