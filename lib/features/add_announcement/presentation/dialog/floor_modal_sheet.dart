...
class FloorModalSheet extends StatefulWidget {
  const FloorModalSheet({
    super.key,
  });

  @override
  State<FloorModalSheet> createState() => _FloorModalSheetState();
}

class _FloorModalSheetState extends State<FloorModalSheet> {
  int activeIndex = 0;
