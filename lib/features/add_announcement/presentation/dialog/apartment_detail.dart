...
class ApartmentDetailBottomSheet extends StatefulWidget {
  const ApartmentDetailBottomSheet({
    super.key,
  });

  @override
  State<ApartmentDetailBottomSheet> createState() => _ApartmentDetailBottomSheetState();
}

class _ApartmentDetailBottomSheetState extends State<ApartmentDetailBottomSheet> {
  int activeIndex = 0;
