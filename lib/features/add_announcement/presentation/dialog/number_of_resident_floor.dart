...
class NumberOfResidentFloor extends StatefulWidget {
  const NumberOfResidentFloor({
    super.key,
  });

  @override
  State<NumberOfResidentFloor> createState() => _NumberOfResidentFloorState();
}

class _NumberOfResidentFloorState extends State<NumberOfResidentFloor> {
  int activeIndex = 0;
